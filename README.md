...
- Mã nguồn 
    ...
    while True:
        ...
        set_level_gpio_output(15, check_state(count, 16))
        set_level_gpio_output(16, check_state(count, 32))
        set_level_gpio_output(17, check_state(count, 64))
        set_level_gpio_output(18, check_state(count, 128))
        print(f"{check_state(count, 128)} {check_state(count, 64)} {check_state(count, 32)} {check_state(count, 16)} {check_state(count, 8)} {check_state(count, 4)} {check_state(count, 2)} {check_state(count, 1)}")
        sleep(1)
        count -= 1
        if count < 0:
            print("END")
    ...
    while True:
        set_level_gpio_output(4, check_state(count, 8))
        set_level_gpio_output(5, check_state(count, 4))
        set_level_gpio_output(6, check_state(count, 2))
        set_level_gpio_output(7, check_state(count, 1))
        set_level_gpio_output(15, check_state(count, 1))
        set_level_gpio_output(16, check_state(count, 2))
        set_level_gpio_output(17, check_state(count, 4))
        set_level_gpio_output(18, check_state(count, 8))
        print(f"{check_state(count, 8)} {check_state(count, 4)} {check_state(count, 2)} {check_state(count, 1)} {check_state(count, 1)} {check_state(count, 2)} {check_state(count, 4)} {check_state(count, 8)}")
        sleep(1)
        count -= 1
        if count < 0:
            print("END")
    ...
    while True:
        ...
        print(f"{check_state(count, 128)} {check_state(count, 64)} {check_state(count, 32)} {check_state(count, 16)} {check_state(count, 8)} {check_state(count, 4)} {check_state(count, 2)} {check_state(count, 1)}")
        sleep(1)
        set_level_gpio_output(4, 1)
        set_level_gpio_output(5, 1)
        set_level_gpio_output(6, 1)
        set_level_gpio_output(7, 1)
        set_level_gpio_output(15, 1)
        set_level_gpio_output(16, 1)
        set_level_gpio_output(17, 1)
        set_level_gpio_output(18, 1)
        print("LED OFF ALL")
        sleep(1)
        count -= 1
        if count < 0:
